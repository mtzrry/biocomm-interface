...
const translations = {
  en: {
    ...
    calibrationFormat: "Header: organism_name, type, baseline_ph, baseline_od, threshold_od",
    clearCalibration: "Clear Calibration",
    calibrationSymbols: "symbols",
    calibrationDictEntries: "dictionary entries",
    // Organism setup
    setupOrganism: "Organism Setup",
    setupOrganismDesc: "Active biological parameters for signal interpretation",
    uploadOrganismProfile: "Upload Organism Profile",
    baselinePh: "Baseline pH",
    baselineOd: "Baseline OD600",
    thresholdOd: "Threshold OD600",
    organismLoaded: "Organism profile loaded",
    invalidOrganismFormat: "Error: Format Profil Organisme tidak valid.",
    simulasiSinyal: "Signal Simulation",
    // Logs
  ...
  id: {
    ...
    sensoryFeedback: "Audio / Haptik",
    sensoryOn: "AKTIF",
    sensoryOff: "MATI",
    decodedResultLabel: "Hasil Dekode",
    morseRepresentation: "Representasi Morse",
    calibrationModel: "Model Kalibrasi",
    uploadCalibration: "Unggah Model Kalibrasi (CSV)",
    calibrationLoaded: "Kalibrasi dimuat",
    calibrationFormat: "Header: organism_name, type, baseline_ph, baseline_od, threshold_od",
    clearCalibration: "Hapus Kalibrasi",
    calibrationSymbols: "simbol",
    calibrationDictEntries: "entri kamus",
    setupOrganism: "Setup Organisme",
    setupOrganismDesc: "Parameter biologi aktif untuk interpretasi sinyal",
    uploadOrganismProfile: "Unggah Profil Organisme",
    baselinePh: "Baseline pH",
    baselineOd: "Baseline OD600",
    thresholdOd: "Threshold OD600",
    organismLoaded: "Profil organisme dimuat",
    invalidOrganismFormat: "Error: Format Profil Organisme tidak valid.",
    simulasiSinyal: "Simulasi Sinyal",
    ...
    logCalibrationLoaded: "[KAL] Model kalibrasi dimuat.",
    logCalibrationCleared: "[KAL] Model kalibrasi dihapus.",
