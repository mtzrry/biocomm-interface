    ...
    <div className="min-h-screen pt-24 pb-16 px-4 sm:px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="glass-panel-strong rounded-2xl p-8">
          ...
          {/* FRAME FOLDER GOOGLE DRIVE (EMBED) */}
          <div className="mt-8 rounded-xl overflow-hidden border border-border bg-black/40 drop-shadow-md">
            <iframe 
              src="https://drive.google.com/embeddedfolderview?id=1btE1TsBuUy7ZJFUz4tvNMHu0LnWisLX7#grid" 
              width="100%" 
              height="450" 
              style={{ border: "none" }}
              title="Micorse Research Documents"
              allow="autoplay"
            ></iframe>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-border flex flex-wrap gap-3">
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-primary text-primary-foreground font-medium text-sm glow-btn hover:scale-105 transition-transform"
            >
